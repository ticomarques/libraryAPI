...
public class AutorController implements GenericController {
    ...
    @Operation(summary = "Obter Detalhes",  description = "Exibe os detalhes do autor pelo id")
    @ApiResponses({
    ...
    @DeleteMapping("{id}")
    @PreAuthorize("hasRole('GERENTE')")
    @Operation(summary = "Apaga Autor",  description = "Apaga o autor pelo id")
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Apagado com sucesso."),
            @ApiResponse(responseCode = "404", description = "Autor não encontrado."),
    ...
    @PutMapping("{id}")
    @PreAuthorize("hasRole('GERENTE')")
    @Operation(summary = "Atualizar",  description = "Atualiza dadaos do autor existente.")
    @ApiResponses({
